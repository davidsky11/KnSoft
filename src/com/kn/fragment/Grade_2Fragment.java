...
public class Grade_2Fragment extends Fragment implements View.OnClickListener {
	...
	private int layoutId = 2130903052;
	...
	// public Grade_2Fragment(int paramInt)
	// {
...
//		new Thread(new LoadDataRunnable(this.grade_1_id)).start();
	...
	public void onViewCreated(View paramView, Bundle paramBundle) {
		...
		this.listView_grade_2 = ((ListView) paramView.findViewById(2131099700));
		// this.listView_grade_2.setOnItemClickListener(new
